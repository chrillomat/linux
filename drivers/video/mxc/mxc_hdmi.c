...
{
        printk("HDMI EDID parameter parser: wandboard_hdmi_force_edid enabled\n");
        if (*str)
                return 0;
        force_edid = 1;
...
__setup("wandboard_hdmi_force_edid", force_edid_setup);
...
{
        printk("HDMI EDID parameter parser: wandboard_hdmi_force_hpdetect enabled\n");
        if (*str)
                return 0;
        force_hpdetect = 1;
...
__setup("wandboard_hdmi_force_hpdetect", force_hpdetect_setup);
